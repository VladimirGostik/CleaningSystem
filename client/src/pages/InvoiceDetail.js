...
import { getInvoiceById, updateInvoice, updateInvoiceAndSyncToMonthly } from '../services/invoices';
import {
  getCompanies,
  getCompanyById,
...
const InvoiceDetail = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!billingMonthNumber || isNaN(billingMonthNumber) || billingMonthNumber < 1 || billingMonthNumber > 12) {
      toast.error('Prosím vyberte platný fakturačný mesiac (1-12).');
      return;
    }
  ...
  const handleSaveAndSyncToMonthly = async (e) => {
    e.preventDefault();
    const billingMonthNumber = billingMonth ? parseInt(billingMonth, 10) : null;
    if (!billingMonthNumber || isNaN(billingMonthNumber) || billingMonthNumber < 1 || billingMonthNumber > 12) {
      toast.error('Prosím vyberte platný fakturačný mesiac (1-12).');
    ...
    const dataToSend = { ...invoiceData, services: servicesData };
    try {
      await updateInvoiceAndSyncToMonthly(id, dataToSend);
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-6xl mx-auto">
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
              ...
              {/* Status */}
              <div className="form-group">
                <label className="block text-green-700 mb-2" htmlFor="status">
                  Status:
                </label>
                <select
                  id="status"
                ...
                >
                  ...
                  <option value="expired">Po splatnosti</option>
                </select>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-3">
              ...
              <div className="p-4 border rounded-md">
                ...
                <div className="mb-2">
                  <label className="block text-green-700 mb-2" htmlFor="companyIcDph">
                    IČ DPH:
                  </label>
                  <input
                    type="text"
                    id="companyIcDph"
                    className="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-400"
                    value={companyDetails.company_ic_dph || ''}
                    onChange={(e) => handleCompanyDetailChange('company_ic_dph', e.target.value)}
                  />
                </div>
              </div>
              ...
              <div className="p-4 border rounded-md">
                ...
                <div className="mb-2">
                  <label className="block text-green-700 mb-2" htmlFor="residentialIcDph">
                    IČ DPH:
                  </label>
                  <input
                    type="text"
                    id="residentialIcDph"
                    className="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-400"
                    value={residentialCompanyDetails.residential_company_ic_dph || ''}
                    onChange={(e) => handleResidentialCompanyDetailChange('residential_company_ic_dph', e.target.value)}
                  />
                </div>
                <div className="mb-2">
                ...
                <div className="mb-2">
                  <label className="block text-green-700 mb-2" htmlFor="residentialBankConnection">
                    Bankové spojenie:
                  </label>
                  <input
                    type="text"
                    id="residentialBankConnection"
                    className="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-400"
                    value={residentialCompanyDetails.bank_connection || ''}
                    onChange={(e) => handleResidentialCompanyDetailChange('bank_connection', e.target.value)}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="flex gap-2">
                ...
                {idMonthlyInvoice && (
                  <button
                    ...
                    onClick={handleSaveAndSyncToMonthly}
                  >
