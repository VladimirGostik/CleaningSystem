...
const EditMonthlyInvoice = ({ closeModal, onSubmit, invoice }) => {
  ...
  useEffect(() => {
    // Inicializácia stavu s existujúcimi dátami faktúry
    if (invoice) {
      ...
      setServices(invoice.services_planned.map(service => ({
        name: service.name,
 ...
 useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    const invoiceData = {
      ...
      id_company: selectedCompany || null, // ID vybratej spoločnosti
      id_residential_company: selectedResidentialCompany || null, // ID vybratej rezidenčnej spoločnosti
      ...
      header4: residentialCompanyDetails.header4 || null, // Prístup cez residentialCompanyDetails
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-2xl font-bold text-green-600">Upraviť mesačnú faktúru</h2>
          <button
            type="button"
