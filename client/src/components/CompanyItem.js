...
const CompanyItem = ({ company, expandedCompany, handleToggleExpand, fetchCompanies }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      toast.success('Firma bola úspešne aktualizovaná');
    } catch (error) {
  ...
  return (
    <div key={company.id} className="bg-gray-100 p-4 rounded-lg shadow-md mb-4">
